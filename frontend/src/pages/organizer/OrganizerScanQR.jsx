...
function OrganizerScanQR() {
    ...
    async function startScanner() {
      try {
        ...
        scannerInstance.render(
          async (decodedText) => {
            // Likayan ang double scan sa parehas nga code sa usa ka session
            ...
            try {
              // 1. I-verify ang ticket reference code
              ...
              if (foundBooking.booking_status === 'confirmed' || foundBooking.booking_status === 'pending') {
                // FIRST SCAN: Check-in Process (Time-in)
                ...
                // Kini nga status 'attended' mao ang mo-unlock sa Review feature sa user side
  ...
  // Helper function para sa status color/badges
